...
class UserActions:
    ...
    def code_default_function(text: str): actions.user.code_public_function(text)
    ...
    def code_private_static_function(text: str): actions.user.code_public_static_function(text)
